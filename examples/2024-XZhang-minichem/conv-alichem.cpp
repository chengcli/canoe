...
// global parameters
Real xH2O, xH2Ov, grav, P0, T0, Z0, Tmin, radius, omega, nu_scalar_iso,
    tau_scale_factor;
bool use_polar_beta;
int s_ind;
...
const std::vector<double> a_prime_CO_low = {
...
const std::vector<double> a_prime_CO_hig = {
...
const std::vector<double> a_prime_CH4_low = {
...
const std::vector<double> a_prime_CH4_hig = {
...
const std::vector<double> a_prime_H2O_low = {
...
const std::vector<double> a_prime_H2O_hig = {
...
// NASA7 Polynomials from BURCAT for PH3 Equilibrium (unprimed - use carefully;
// for G(T)):
const std::vector<double> H3PO4_nasa_coeff_low = {
    -1.82480022E+00, 6.92983740E-02,  -1.01448758E-04, 6.91910155E-08,
    -1.77690951E-11, -1.36317149E+05, 3.30354162E+01};
const std::vector<double> H3PO4_nasa_coeff_hig = {
    1.38520189E+01,  4.93643885E-03,  -1.55822515E-06, 2.29340638E-10,
    -1.28366239E-14, -1.39420678E+05, -4.22913846E+01};
const std::vector<double> PH3_nasa_coeff_low = {
    4.17009763E+00, -5.06487157E-03, 2.86027846E-05, -3.13123782E-08,
    1.13447768E-11, 2.03144445E+02,  2.02004617E+00};
const std::vector<double> PH3_nasa_coeff_hig = {
    3.71229298E+00,  5.85959002E-03,  -2.16607791E-06, 3.56195511E-10,
    -2.15913467E-14, -1.88863997E+02, 1.92781913E+00};
const std::vector<double> H2O_nasa_coeff_low = {
    4.198640560E+00, -2.036434100E-03, 6.520402110E-06, -5.487970620E-09,
    1.771978170E-12, -3.029372670E+04, -8.490322080E-01};
const std::vector<double> H2O_nasa_coeff_hig = {
    3.033992490E+00, 2.176918040E-03,  -1.640725180E-07, -9.704198700E-11,
    1.682009920E-14, -3.000429710E+04, 4.966770100E+00};
const std::vector<double> H2_nasa_coeff_low = {
    2.344331120E+00,  7.980520750E-03,  -1.947815100E-05, 2.015720940E-08,
    -7.376117610E-12, -9.179351730E+02, 6.830102380E-01};
const std::vector<double> H2_nasa_coeff_hig = {
...
const std::vector<double> H_nasa_coeff_low = {
    2.500000000E+00,  7.053328190E-13, -1.995919640E-15, 2.300816320E-18,
    -9.277323320E-22, 2.547365990E+04, -4.466828530E-01};
const std::vector<double> H_nasa_coeff_hig = {
    2.500000010E+00, -2.308429730E-11, 1.615619480E-14, -4.735152350E-18,
    4.981973570E-22, 2.547365990E+04,  -4.466829140E-01};
const std::vector<double> PO2_nasa_coeff_low = {
    3.70338274E+00, 1.99856635E-03,  8.62444075E-06, -1.34479846E-08,
    5.58470721E-12, -3.51050019E+04, 8.53959173E+00};
const std::vector<double> PO2_nasa_coeff_hig = {
    5.27587261E+00,  1.80638038E-03,  -7.50028350E-07, 1.40062873E-10,
    -9.17506743E-15, -3.57348111E+04, -5.74241509E-01};
const std::vector<double> HOPO2_nasa_coeff_low = {
const std::vector<double> GeH4_calc_coeff_low = {
    2.54992789E+00, 7.13885765E-03, 1.43758337E-05, -2.33592977E-08,
    9.65676013E-12, 9.69756465E+03, 9.02678812E+00};
const std::vector<double> GeH4_calc_coeff_hig = {
    5.41474159E+00,  7.24155154E-03, -2.71818301E-06, 4.51535021E-10,
    -2.75635275E-14, 8.46356611E+03, -7.83419271E+00};
const std::vector<double> GeH2_calc_coeff_low = {
    3.7766671605834596,   0.0009625978066155319,  3.939252214813524e-06,
    -3.8051748899537e-09, 1.0224338840428087e-12, 28811.902151701965,
    5.704596034306216};
// GeH2 coefficients have more error in the high T limit (as demonstrated by CH2
// and SiH2)
...
double R_dry_J =
    R_uni / 2.22 / 1e-3;  // J/kg/K using conventional mean_mu for a dry Jupiter
...
// Given a value x and arrays X and T, it finds the appropriate interval in X
// and interpolates the corresponding value in T.
double linearInterpolate(const std::vector<double> &X,
                         const std::vector<double> &T, double x) {
  ...
  // Edge case handling: if x matches the last element, interpolate with the
  // second last
  if (index == X.size()) {
    index--;
  }
...
double X_CO_Eq(double press, double Temp, double X_CH4, double X_H2O,
               double X_H2) {
  ...
  for (int k = ks; k <= ke; ++k)
    for (int j = js; j <= je; ++j)
      for (int i = is; i <= ie; ++i) {
        ...
        mean_mu = 1E3 * w(IDN, k, j, i) * R_uni * temperature /
                  w(IPR, k, j, i);  // technically uses virtual temperature
        // particle number density in molecules/cm3:
        n_particle_density =
            10.0 * w(IDN, k, j, i) * R_dry_J /
            kBoltz;  // --> kg/m3 * (J/kg/K) / (ergs/K) * 1e7 * 1e-6
        ...
        if (NCHEMISTRY > 0) {
          if (NCHEMISTRY == 1) {
            for (int n = 0; n < NCHEMISTRY; ++n) {
              // Passive Scalar CO
              if (s_ind == 1) {
                double tau = tau_scale_factor * 5E-6 *
                             exp(2.8E4 / temperature) *
                             pow(w(IPR, k, j, i) / 1E5, -1.29);
                //                double C_CO_equi = X_CO_Eq(w(IPR,k,j,i),
                //                temperature,
                //                                    X_CH4, X_H2O, X_H2) *
                //                                    w(IDN,k,j,i)
                //                                    * (mu_CO/mean_mu); //
                //                                    conversion factor to Mass
                //                                    fraction;
                // pmb->pscalars->s(n,k,j,i) -= dt  * (pmb->pscalars->s(n,k,j,i)
                // - C_CO_equi) / tau;

                double C_CO_equi =
                    X_CO_Eq(w(IPR, k, j, i), temperature, X_CH4, X_H2O, X_H2) *
                    (mu_CO / mean_mu);  // conversion factor to Mass fraction;
                //             pmb->pscalars->s(NCLOUD +n,k,j,i) -= dt  *
                //             (pmb->pscalars->r(NCLOUD + n,k,j,i) - C_CO_equi)
                //             / tau * w(IDN,k,j,i);
                cons_scalar(NCLOUD + n, k, j, i) -=
                    dt * (prim_scalar(NCLOUD + n, k, j, i) - C_CO_equi) / tau *
                    w(IDN, k, j, i);
              }
              ...
              if (s_ind == 2) {
                ...
                double C_PH3_equi =
                    X_PH3_Eq(temperature, X_H2O, X_H2) * w(IDN, k, j, i) *
                    (mu_PH3 / mean_mu);  // conversion factor to Mass fraction;
                //                pmb->pscalars->s(n,k,j,i) -= dt  *
                //                (pmb->pscalars->s(n,k,j,i) - C_PH3_equi) /
                //                tau;
              }

              // Passive Scalar for GeH4
              if (s_ind == 3) {
                double k4b = 3.57e-14 * pow(temperature, 0.7) *
                             exp(-4956. / temperature);
                double K_GeH2 = KeqGeH2(temperature);

                // No discontinuity occurs with 1E3. We might need to add a
                // minimum timescale to limit numerical instability
                double tau =
                    fmax(10., (w(IPR, k, j, i) / 1E5) * X_H2 /
                                  (k4b * K_GeH2 * n_particle_density * X_H2S));
                double C_GeH4_equi =
                    pow(10,
                        linearInterpolate(T_FL, xgeh4FL_powers, temperature)) *
                    (mu_GeH4 / mean_mu) * w(IDN, k, j, i) * X_H2 * E_Ge / 6.0;

                //                pmb->pscalars->s(n,k,j,i) -= dt  *
                //                (pmb->pscalars->s(n,k,j,i) - C_GeH4_equi) /
                //                tau;
              }
            }
          }
...
void MeshBlock::ProblemGenerator(ParameterInput *pin) {
  ...
  if (NVAPOR > 0) xH2Ov = pin->GetReal("problem", "qH2O.ppmv") / 1.E6;

  while (iter++ < max_iter) {
    // read in vapors
    if (NVAPOR > 0) air.w[iH2O] = xH2Ov;
    air.w[IPR] = Ps;
    air.w[IDN] = Ts;
  ...
  /*
    ...
    Real dz, **w1, *z1, *p1, *t1;
    if (x1rat != 1.0) {
      dz = (x1max - x1min)*(x1rat - 1.)/(pow(x1rat, pmy_mesh->mesh_size.nx1)
  - 1.); dz = std::min(dz, dz*pow(x1rat, pmy_mesh->mesh_size.nx1))/2.; } else {
  ...
  << std::endl; while (iter++ < max_iter) { pthermo->ConstructAdiabat(w1, Ts,
  Ps, grav, dz, nx1, Adiabat::pseudo);
  ...
  temperature is too low int ii = 0; for (; ii < nx1-1; ++ii) if
  (pthermo->GetTemp(w1[ii]) < Tmin) break; Real Tv =
  w1[ii][IPR]/(w1[ii][IDN]*Rd); for (int i = ii; i < nx1; ++i) { w1[i][IPR] =
  w1[ii][IPR]*exp(-grav*(z1[i] - z1[ii])/(Rd*Tv)); w1[i][IDN] =
  w1[i][IPR]/(Rd*Tv); for (int n = 1; n <= NVAPOR; ++n) w1[i][n] = w1[ii][n];
      }
      ...
      if (Globals::my_rank == 0)
        std::cout << "- iteration #" << iter << ": " << "T = " << t0 << " P = "
  << p0 << std::endl;
    }
  ...
  if (NCHEMISTRY > 0) {
    if (NCHEMISTRY ==
        1) {  // If configured to single scalar.  Here, s_ind is important.
      for (int n = 0; n < NCHEMISTRY; ++n) {
        for (int i = is; i <= ie; ++i) {
          for (int k = ks; k <= ke; ++k) {
            for (int j = js; j <= je; ++j) {
              temperature = pthermo->GetTemp(phydro->w.at(k, j, i));
              mean_mu = 1E3 * phydro->w(IDN, k, j, i) * R_uni * temperature /
                        phydro->w(IPR, k, j, i);
              // Set water mole fraction appropriately:
              if (NVAPOR > 0) {
                // if moist case is used, set X_H2O to the evolving water
                // content.
              ...
              if (s_ind == 1) {
                ...
                //              X_CO_Eq(phydro->w(IPR,k,j,i), temperature,
                //                                      X_CH4, X_H2O, X_H2) *
                //                                      (mu_CO/mean_mu) *
                //                                      phydro->w(IDN,k,j,i);
                pscalars->r(NCLOUD + n, k, j, i) =
                    X_CO_Eq(phydro->w(IPR, k, j, i), temperature, X_CH4, X_H2O,
                            X_H2) *
                    (mu_CO / mean_mu);
              }
              // s_ind = 2 for PH3 initial equilibrium condition
              if (s_ind == 2) {
                pscalars->s(n, k, j, i) = X_PH3_Eq(temperature, X_H2O, X_H2) *
                                          (mu_PH3 / mean_mu) *
                                          phydro->w(IDN, k, j, i);
              }
              // s_ind = 3 for GeH4 initial equilibrium condition
              if (s_ind == 3) {
                // Dividing out 6.0 due to the enrichment of Ge used in Fegley &
                // Lodders, 1994.
                pscalars->s(n, k, j, i) =
                    pow(10,
                        linearInterpolate(T_FL, xgeh4FL_powers, temperature)) *
                    (mu_GeH4 / mean_mu) * phydro->w(IDN, k, j, i) * X_H2 *
                    E_Ge / 6.0;
              }
            }
          }
    ...
    if (NCHEMISTRY == 2) {  // If configured to 2 scalars.  CO is ignored and
                            // PH3 and GeH4 are modeled.
      for (int n = 0; n < NCHEMISTRY; ++n) {
        for (int i = is; i <= ie; ++i) {
          for (int k = ks; k <= ke; ++k) {
            for (int j = js; j <= je; ++j) {
              ...
              // n = 0 for PH3 initial equilibrium condition if NCHEMISTRY == 2
              if (n == 0) {
                pscalars->s(n, k, j, i) = X_PH3_Eq(temperature, X_H2O, X_H2) *
                                          (mu_PH3 / mean_mu) *
                                          phydro->w(IDN, k, j, i);
              }
              // n = 1 for GeH4 initial equilibrium condition if NCHEMISTRY == 2
              if (n == 1) {
                // Dividing out 6.0 due to the enrichment of Ge used in Fegley &
                // Lodders, 1994.
                pscalars->s(n, k, j, i) =
  ...
  // std::cout << "Interpolated at 1050.0 K = " << pow(10,
  // linearInterpolate(T_FL, xgeh4FL_powers, 1050.0)) << std::endl;
  ...
  //       for (int k = ks; k <= ke; ++k){
  //         for (int j = js; j <= je; ++j){
  //           pscalars->s(n,k,j,i) = X_CO_Eq(phydro->w(IPR,k,j,i),
  ...
  /*
      ...
      for (int k = ks; k <= ke; ++k){
        for (int j = js; j <= je; ++j){
          phydro->w(IM1,k,j,i) = 0.01*(1.*rand()/RAND_MAX - 0.5);
          }
        }
    }
  */
