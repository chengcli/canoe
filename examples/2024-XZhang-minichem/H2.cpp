...
// this class header
#include <athena/chemistry/network/H2.hpp>
...
#include <athena/units/units.hpp>
#include <athena/chemistry/utils/chemistry_utils.hpp>
#include <athena/chemistry/utils/thermo.hpp>
#include <athena/chemistry/network/network.hpp>
