...
void MeshBlock::ProblemGenerator(ParameterInput *pin) {
  ...
  // u: conserved variable, (rho, rho*u, rho*v, rho*w, E)
  // diagnostic variables
  // w: primitive variable, (rho, u, v, w, p)
  // IDN: density
  // VAPOR1: vapor 1 mass fraction (kg/kg)
  // VAPOR2: vapor 2 mass fraction (kg/kg)
  // CLOUD1: cloud 1 mass fraction (kg/kg)
  // CLOUD2: cloud 2 mass fraction (kg/kg)
  // ....
  // IVX: x-velocity (vertical)
  // IVY: y-velocity (horizontal)
  // IVZ: z-velocity (horizontal)
  // IPR: pressure
  // i: vertical
  // k,j : horizontal
