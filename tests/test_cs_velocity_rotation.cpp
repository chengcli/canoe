...
TEST(vel_zab_to_zxy, test_ab_to_xy_to_ab) {
  ...
  cs::vel_zxy_to_zab(vz, vx, vy, PI / 3, PI / 4);
  std::cout << *vz << " " << *vx << " " << *vy;
  cs::vel_zab_to_zxy(vz, vx, vy, PI / 3, PI / 4);
  for (int i = 0; i < 3; i++) {
...
TEST(vel_zab_from_test, test_case_1_to_2_to_1) {
  ...
  Real *vy = result + 2;
  Real expected_result[3] = {1, 2, 3};
  cs::vel_zab_from_p1(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 2);
  cs::vel_zab_from_p2(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 1);
  for (int i = 0; i < 3; i++) {
    EXPECT_NEAR(result[i], expected_result[i], 1e-5);
  }
}
...
TEST(vel_zab_from_test, test_case_1_to_3_to_1) {
  ...
  Real *vy = result + 2;
  Real expected_result[3] = {1, 2, 3};
  cs::vel_zab_from_p1(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 3);
  cs::vel_zab_from_p3(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 1);
  for (int i = 0; i < 3; i++) {
    EXPECT_NEAR(result[i], expected_result[i], 1e-5);
  }
}
...
TEST(vel_zab_from_test, test_case_1_to_4_to_1) {
  ...
  Real *vy = result + 2;
  Real expected_result[3] = {1, 2, 3};
  cs::vel_zab_from_p1(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 4);
  cs::vel_zab_from_p4(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 1);
  for (int i = 0; i < 3; i++) {
    EXPECT_NEAR(result[i], expected_result[i], 1e-5);
  }
}
...
TEST(vel_zab_from_test, test_case_1_to_6_to_1) {
  ...
  Real *vy = result + 2;
  Real expected_result[3] = {1, 2, 3};
  cs::vel_zab_from_p1(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 6);
  cs::vel_zab_from_p6(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 1);
  for (int i = 0; i < 3; i++) {
    EXPECT_NEAR(result[i], expected_result[i], 1e-5);
  }
}
...
TEST(vel_zab_from_test, test_case_2_to_3_to_2) {
  ...
  Real *vy = result + 2;
  Real expected_result[3] = {1, 2, 3};
  cs::vel_zab_from_p2(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 3);
  cs::vel_zab_from_p3(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 2);
  for (int i = 0; i < 3; i++) {
    EXPECT_NEAR(result[i], expected_result[i], 1e-5);
  }
}
...
TEST(vel_zab_from_test, test_case_2_to_4_to_2) {
  ...
  Real *vy = result + 2;
  Real expected_result[3] = {1, 2, 3};
  cs::vel_zab_from_p2(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 4);
  cs::vel_zab_from_p4(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 2);
  for (int i = 0; i < 3; i++) {
    EXPECT_NEAR(result[i], expected_result[i], 1e-5);
  }
}
...
TEST(vel_zab_from_test, test_case_2_to_5_to_2) {
  ...
  Real *vy = result + 2;
  Real expected_result[3] = {1, 2, 3};
  cs::vel_zab_from_p2(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 5);
  cs::vel_zab_from_p5(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 2);
  for (int i = 0; i < 3; i++) {
    EXPECT_NEAR(result[i], expected_result[i], 1e-5);
  }
}
...
TEST(vel_zab_from_test, test_case_3_to_5_to_3) {
  ...
  Real *vy = result + 2;
  Real expected_result[3] = {1, 2, 3};
  cs::vel_zab_from_p3(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 5);
  cs::vel_zab_from_p5(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 3);
  for (int i = 0; i < 3; i++) {
    EXPECT_NEAR(result[i], expected_result[i], 1e-5);
  }
}
...
TEST(vel_zab_from_test, test_case_3_to_6_to_3) {
  ...
  Real *vy = result + 2;
  Real expected_result[3] = {1, 2, 3};
  cs::vel_zab_from_p3(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 6);
  cs::vel_zab_from_p6(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 3);
  for (int i = 0; i < 3; i++) {
    EXPECT_NEAR(result[i], expected_result[i], 1e-5);
  }
}
...
TEST(vel_zab_from_test, test_case_4_to_5_to_4) {
  ...
  Real *vy = result + 2;
  Real expected_result[3] = {1, 2, 3};
  cs::vel_zab_from_p4(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 5);
  cs::vel_zab_from_p5(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 4);
  for (int i = 0; i < 3; i++) {
    EXPECT_NEAR(result[i], expected_result[i], 1e-5);
  }
}
...
TEST(vel_zab_from_test, test_case_4_to_6_to_4) {
  ...
  Real *vy = result + 2;
  Real expected_result[3] = {1, 2, 3};
  cs::vel_zab_from_p4(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 6);
  cs::vel_zab_from_p6(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 4);
  for (int i = 0; i < 3; i++) {
    EXPECT_NEAR(result[i], expected_result[i], 1e-5);
  }
}
...
TEST(vel_zab_from_test, test_case_5_to_6_to_5) {
  ...
  Real *vy = result + 2;
  Real expected_result[3] = {1, 2, 3};
  cs::vel_zab_from_p5(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 6);
  cs::vel_zab_from_p6(vz, vx, vy, PI / 5 * 2, PI / 8 * 3, 5);
  for (int i = 0; i < 3; i++) {
    EXPECT_NEAR(result[i], expected_result[i], 1e-5);
  }
}
