...
if __name__ == "__main__":
    ...
    for ab in band.absorbers():
        if ab.get_name() == "H2O":
            ab.load_opacity_from_file("kcoeff-ir-rotational.nc")
        elif ab.get_name() == "H2-H2-CIA":
            ab.load_opacity_from_file("H2-H2-eq.xiz.txt")
        elif ab.get_name() == "H2-He-CIA":
            ab.load_opacity_from_file("H2-He-eq.xiz.txt")
        else:
            raise ValueError("Unknown absorber")

    ab = band.get_absorber(0)
