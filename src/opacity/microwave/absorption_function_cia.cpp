...
static double const Lo_mks       = 2.68719e25;         // Loschmidt number molecules/m^3 at STP
       ...
       double XHe, double XCH4, double mix)
{
   ...
   if (mix==0.0) {
      h2h2 = amagat_h2 * amagat_h2 * exp(CIA_Orton::CIA_H2_H2_e(It0,Inu0,nu_invcm,logT));
      h2he = amagat_h2 * amagat_he * exp(CIA_Orton::CIA_H2_He_e(It0,Inu0,nu_invcm,logT));
      h2ch4 = amagat_h2 * amagat_ch4 * exp(CIA_Orton::CIA_H2_CH4_e(It0,Inu0,nu_invcm,logT));
   }
   else if (mix==1.0) {
      h2h2 = amagat_h2 * amagat_h2 * exp(CIA_Orton::CIA_H2_H2_n(It0,Inu0,nu_invcm,logT));
      h2he = amagat_h2 * amagat_he * exp(CIA_Orton::CIA_H2_He_n(It0,Inu0,nu_invcm,logT));
      h2ch4 = amagat_h2 * amagat_ch4 * exp(CIA_Orton::CIA_H2_CH4_n(It0,Inu0,nu_invcm,logT));
   }
   else {
      h2h2 = amagat_h2 * amagat_h2 * (mix*exp(CIA_Orton::CIA_H2_H2_e(It0,Inu0,nu_invcm,logT)) +
                                      (1-mix)*exp(CIA_Orton::CIA_H2_H2_n(It0,Inu0,nu_invcm,logT)));
      h2he = amagat_h2 * amagat_he * (mix*exp(CIA_Orton::CIA_H2_He_e(It0,Inu0,nu_invcm,logT)) +
                                      (1-mix)*exp(CIA_Orton::CIA_H2_He_n(It0,Inu0,nu_invcm,logT)));
      h2ch4 = amagat_h2 * amagat_ch4 * (mix*exp(CIA_Orton::CIA_H2_CH4_e(It0,Inu0,nu_invcm,logT)) +
