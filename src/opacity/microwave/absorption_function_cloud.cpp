       ...
       double rho_H2O, double rho_NH4SH, double rho_NH3, double cfliq, double cfwice, double cfaice)
{
   ...
   //  Atmospheric Remote Sensing by Microwave Radiometer, Ed. Michael A. Janssen,
   //  Wiley, Page 332. 1993.
   ...
   double bb = 1.0e-4*(0.502-0.131*tt)/tt1 + 0.542e-6*tt1*tt1/(tt2*tt2);
   ...
   return cfliq*acldl*rho_NH3_H2O + cfwice*acldw*rho_H2O + cfaice*aclda*(rho_NH4SH+rho_NH3);
}
