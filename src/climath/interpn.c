 ...
 * data[...]        : points to the start position of a multidimensional data table.
 * len[0..ndim-1]   : length of each dimension
 * axis[...]        : coordinates of each dimesnion is placed sequentially in axis
 */
