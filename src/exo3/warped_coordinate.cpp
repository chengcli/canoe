...
void WarpedCoordinate::VolCenterFace1Area(const int k, const int j,
...
void WarpedCoordinate::VolCenterFace2Area(const int k, const int j,
                                          const int il, const int iu,
                                          AthenaArray<Real> &area) {
#pragma omp simd
  for (int i = il; i <= iu; ++i) {
...
void WarpedCoordinate::VolCenterFace3Area(const int k, const int j,
                                          const int il, const int iu,
                                          AthenaArray<Real> &area) {
#pragma omp simd
  for (int i = il; i <= iu; ++i) {
...
//----------------------------------------------------------------------------------------
// For Warped coordinate: the metrics are all the same for volume, faces
void WarpedCoordinate::CellMetric(const int k, const int j, const int il,
...
void WarpedCoordinate::Face1Metric(const int k, const int j, const int il,
                                   const int iu, AthenaArray<Real> &g,
                                   AthenaArray<Real> &g_inv) {
  // Go through 1D block of cells
#pragma omp simd
...
void WarpedCoordinate::Face2Metric(const int k, const int j, const int il,
                                   const int iu, AthenaArray<Real> &g,
                                   AthenaArray<Real> &g_inv) {
  // Go through 1D block of cells
#pragma omp simd
...
void WarpedCoordinate::Face3Metric(const int k, const int j, const int il,
                                   const int iu, AthenaArray<Real> &g,
                                   AthenaArray<Real> &g_inv) {
  // Go through 1D block of cells
#pragma omp simd
...
void WarpedCoordinate::PrimToLocal2(const int k, const int j, const int il,
                                    const int iu,
...
void WarpedCoordinate::PrimToLocal3(const int k, const int j, const int il,
                                    const int iu,
                                    const AthenaArray<Real> &b1_vals,
                                    AthenaArray<Real> &prim_left,
                                    AthenaArray<Real> &prim_right,
...
void WarpedCoordinate::FluxToGlobal2(
...
void WarpedCoordinate::FluxToGlobal3(
    const int k, const int j, const int il, const int iu,
    const AthenaArray<Real> &cons, const AthenaArray<Real> &bbx,
    AthenaArray<Real> &flux, AthenaArray<Real> &ey, AthenaArray<Real> &ez) {
  // Extract metrics
