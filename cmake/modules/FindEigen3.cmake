...
# find_package(Eigen3 3.1.2) to require version 3.1.2 or newer of Eigen3.
#
# Once done this will define
#
# EIGEN3_FOUND - system has eigen lib with correct version EIGEN3_INCLUDE_DIR -
# the eigen include directory EIGEN3_VERSION - eigen version
#
# This module reads hints about search locations from the following enviroment
# variables:
#
# EIGEN3_ROOT EIGEN3_ROOT_DIR

# Copyright (c) 2006, 2007 Montel Laurent, <montel@kde.org> Copyright (c) 2008,
# 2009 Gael Guennebaud, <g.gael@free.fr> Copyright (c) 2009 Benoit Jacob
# <jacob.benoit.1@gmail.com> Redistribution and use is allowed according to the
...
if(EIGEN3_INCLUDE_DIR)
  ...
  if(NOT EIGEN3_INCLUDE_DIR)
    find_path(
      ...
      HINTS ENV EIGEN3_ROOT ENV EIGEN3_ROOT_DIR $ENV{HOME}/opt/include
